...
@click.option('--bypass-warning', '--bypass-patch-warning', 'bypass_patch_warning', type=click.Choice(['on', 'off']), required=False, is_flag=False, flag_value='show', help="Bypass driver patch warning. No arg shows current.")
